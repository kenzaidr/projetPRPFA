...
export default function HomePage() {
    ...
    return (
        <div className="font-inter bg-white" dir={config.dir}>
            {/* Navigation */}
            <nav className="fixed w-full bg-white/95 backdrop-blur-md shadow-sm z-50 transition-all duration-300">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/')}>
                            <div className="w-10 h-10 bg-gradient-to-br from-morocco-red to-morocco-green rounded-lg flex items-center justify-center shadow-md">
                        ...
                        <div className="hidden md:flex items-center gap-8">
                            <a 
                                ...
                                className="text-gray-700 hover:text-morocco-red transition-colors font-medium"
                            >
                                {t('nav.services')}
                            </a>
                            <a 
                            ...
                            <Link 
                                to="/driver"
                                className="text-gray-700 hover:text-morocco-red transition-colors font-medium flex items-center gap-1"
                            >
                                {t('nav.partner')}
                            </Link>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div className="relative language-switcher">
                                ...
                                >
                                    <span className="w-5 h-5 flex items-center justify-center text-gray-700 font-bold text-xs border border-gray-300 rounded-sm">
                                        {currentLang.toUpperCase()}
                                    </span>
                                    <span id="currentLang" className="font-medium text-gray-700 hidden sm:inline">{currentLang.toUpperCase()}</span>
                                    <ChevronDown size={16} className="text-gray-700" />
                                </button>
                                <div 
                                    ref={languageDropdownRef}
                                    id="languageDropdown" 
                                    className={`${languageDropdownOpen ? '' : 'hidden'} absolute top-full mt-2 right-0 bg-white rounded-lg shadow-xl border border-gray-200 py-2 min-w-[150px] z-50`}
                                >
                                    <button 
                                        onClick={() => handleLanguageChange('ar')}
                                        className={`w-full px-4 py-2 text-right hover:bg-morocco-red/5 transition-colors flex items-center justify-between gap-3 ${currentLang === 'ar' ? 'bg-morocco-red/10 text-morocco-red font-semibold' : ''}`}
                                    >
                                    ...
                                    <button 
                                        ...
                                        className={`w-full px-4 py-2 text-right hover:bg-morocco-red/5 transition-colors flex items-center justify-between gap-3 ${currentLang === 'fr' ? 'bg-morocco-red/10 text-morocco-red font-semibold' : ''}`}
                                    >
                                    ...
                                    <button 
                                        ...
                                        className={`w-full px-4 py-2 text-right hover:bg-morocco-red/5 transition-colors flex items-center justify-between gap-3 ${currentLang === 'en' ? 'bg-morocco-red/10 text-morocco-red font-semibold' : ''}`}
                                    >
                            ...
                            <Link to="/driver" className="hidden md:block px-6 py-2.5 text-morocco-red font-semibold hover:bg-morocco-red/5 rounded-lg transition-all">
                                {t('nav.login')}
                            </Link>
                            <button className="px-6 py-2.5 bg-gradient-to-r from-morocco-red to-morocco-green text-white font-semibold rounded-lg hover:shadow-lg hover:scale-105 transition-all">
                                {t('nav.downloadApp')}
                            </button>
                            <button 
                ...
                {/* Mobile Menu */}
                {mobileMenuOpen && (
                    <div className="md:hidden bg-white border-t border-gray-200 p-6 shadow-xl animate-in slide-in-from-top-5">
                        <div className="flex flex-col gap-4 text-right">
                            <a 
                                href="#services" 
                                onClick={(e) => handleSmoothScroll(e, 'services')}
                                className="text-gray-700 hover:text-morocco-red transition-colors font-medium py-2"
                            >
                                {t('nav.services')}
                            </a>
                            <a 
                            ...
                            <Link 
                                to="/driver"
                                className="w-full px-6 py-2.5 text-morocco-red font-semibold hover:bg-morocco-red/5 rounded-lg transition-all text-center border border-morocco-red/20"
                                onClick={() => setMobileMenuOpen(false)}
                            >
                                {t('nav.login')}
                            </Link>
            ...
            <section className="relative min-h-screen flex items-center overflow-hidden pt-20">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        {/* Hero Content */}
                        <div className="text-right lg:text-left rtl:lg:text-right">
                            <div className="inline-block mb-6 px-4 py-2 bg-morocco-gold/20 rounded-full">
                                <span className="text-morocco-red font-semibold text-sm">{t('hero.badge')}</span>
                            </div>
                            
                            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
                                <span className="bg-gradient-to-r from-morocco-red via-morocco-green to-morocco-gold bg-clip-text text-transparent">
                                    {t('hero.title1')}
                                </span>
                                <br />
                            ...
                            <div className="flex flex-wrap gap-4 justify-end lg:justify-start rtl:lg:justify-end mb-8">
                                <button className="group px-8 py-4 bg-gradient-to-r from-morocco-red to-morocco-green text-white font-bold rounded-xl hover:shadow-2xl hover:scale-105 transition-all duration-300">
                                ...
                                <button className="px-8 py-4 bg-white border-2 border-morocco-red text-morocco-red font-bold rounded-xl hover:bg-morocco-red hover:text-white transition-all duration-300 flex items-center gap-2">
                                    <Play size={20} fill="currentColor" />
                                    {t('hero.watchVideo')}
                                </button>
                            </div>
                            
                            <div className="flex gap-8 justify-end lg:justify-start rtl:lg:justify-end">
                        ...
                        <div className="relative">
                            ...
                            <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl shadow-xl p-6 animate-float z-20">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div className="text-sm text-gray-600">{t('hero.nextRide')}</div>
                                        <div className="font-bold text-morocco-green">{t('hero.nextRideTime')}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="absolute -top-6 -left-6 bg-white rounded-2xl shadow-xl p-6 animate-float-delayed z-20">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div className="text-sm text-gray-600">{t('hero.foodDelivery')}</div>
                                        <div className="font-bold text-morocco-red">{t('hero.foodDeliveryTime')}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-bold mb-4">
                            <span className="bg-gradient-to-r from-morocco-red to-morocco-green bg-clip-text text-transparent">
                                {t('services.title')}
                            </span>
                        </h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden">
                            ...
                            <div className="relative z-10 flex flex-col items-end">
                                <div className="w-16 h-16 bg-gradient-to-br from-morocco-red to-morocco-red/70 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform shadow-lg shadow-morocco-red/30">
                                    <Car className="text-white w-8 h-8" />
                                </div>
                                
                                <h3 className="text-2xl font-bold mb-3 text-right">{t('services.ride.title')}</h3>
                                <p className="text-gray-600 mb-6 text-right leading-relaxed">
                                    {t('services.ride.description')}
                                </p>
                                
                                <div className="flex justify-end w-full">
                                    <button className="text-morocco-red font-semibold flex items-center gap-2 group-hover:gap-3 transition-all">
                        ...
                        <div className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden">
                            ...
                            <div className="relative z-10 flex flex-col items-end">
                                <div className="w-16 h-16 bg-gradient-to-br from-morocco-green to-morocco-green/70 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform shadow-lg shadow-morocco-green/30">
                                    <Utensils className="text-white w-8 h-8" />
                                </div>
                                
                                <h3 className="text-2xl font-bold mb-3 text-right">{t('services.food.title')}</h3>
                                <p className="text-gray-600 mb-6 text-right leading-relaxed">
                        ...
                        <div className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden">
                            ...
                            <div className="relative z-10 flex flex-col items-end">
                                <div className="w-16 h-16 bg-gradient-to-br from-morocco-gold to-morocco-gold/70 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform shadow-lg shadow-morocco-gold/30">
                                    <Package className="text-white w-8 h-8" />
                                </div>
                                
                                <h3 className="text-2xl font-bold mb-3 text-right">{t('services.package.title')}</h3>
                                <p className="text-gray-600 mb-6 text-right leading-relaxed">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-12 relative">
                        ...
                        <div className="text-center relative">
                            <div className="w-20 h-20 bg-gradient-to-br from-morocco-red to-morocco-red/70 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg text-white">
                        ...
                        {/* Step 2 */}
                        <div className="text-center relative">
                            <div className="w-20 h-20 bg-gradient-to-br from-morocco-green to-morocco-green/70 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg text-white">
                        ...
                        {/* Step 3 */}
                        <div className="text-center relative">
                            <div className="w-20 h-20 bg-gradient-to-br from-morocco-gold to-morocco-gold/70 rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg text-white">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow text-right">
                            ...
                            <h3 className="text-xl font-bold mb-2">{t('features.safety.title')}</h3>
                            <p className="text-gray-600">{t('features.safety.description')}</p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow text-right">
                            ...
                            <h3 className="text-xl font-bold mb-2">{t('features.payment.title')}</h3>
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow text-right">
                            ...
                            <h3 className="text-xl font-bold mb-2">{t('features.tracking.title')}</h3>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="text-right text-white">
                            <h2 className="text-4xl md:text-5xl font-bold mb-6">{t('partner.title')}</h2>
                            ...
                            <div className="grid grid-cols-2 gap-6 mb-8">
                                <div>
                                    <div className="text-3xl font-bold mb-1">15,000 MAD+</div>
                                    <div className="text-white/80">{t('partner.income')}</div>
                                </div>
                                <div>
                                    <div className="text-3xl font-bold mb-1">24/7</div>
                                    <div className="text-white/80">{t('partner.support')}</div>
                                </div>
                            </div>
                            
                            <Link 
                                to="/driver"
                                className="inline-block px-8 py-4 bg-white text-morocco-red font-bold rounded-xl hover:shadow-2xl hover:scale-105 transition-all"
                            >
                                {t('partner.cta')}
                            </Link>
                        </div>
                    ...
                    <div className="grid md:grid-cols-4 gap-12 mb-12">
                        ...
                        <div className="text-right">
                            ...
                            <ul className="space-y-2 text-gray-400">
                                ...
                                <li><a href="#" className="hover:text-white transition-colors">{t('footer.company.news')}</a></li>
                            </ul>
                        </div>
                        ...
                        <div className="text-right">
                            ...
                            <ul className="space-y-2 text-gray-400">
                                <li><a href="#" className="hover:text-white transition-colors">{t('footer.services.ride')}</a></li>
                                <li><a href="#" className="hover:text-white transition-colors">{t('footer.services.food')}</a></li>
                                <li><a href="#" className="hover:text-white transition-colors">{t('footer.services.package')}</a></li>
                            </ul>
                        </div>
                        ...
                        <div className="text-right">
                            ...
                            <ul className="space-y-2 text-gray-400">
                                <li><a href="#" className="hover:text-white transition-colors">{t('footer.support.help')}</a></li>
                                <li><a href="#" className="hover:text-white transition-colors">{t('footer.support.safety')}</a></li>
                                <li><a href="#" className="hover:text-white transition-colors">{t('footer.support.contact')}</a></li>
                            </ul>
                        </div>
                    </div>
